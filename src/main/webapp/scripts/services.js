...
cvappApp.factory('Register', function ($resource) {
        return $resource('app/rest/register', {}, {
        });
    });

cvappApp.factory('Activate', function ($resource) {
        return $resource('app/rest/activate', {}, {
            'get': { method: 'GET', params: {}, isArray: false}
        });
    });

cvappApp.factory('Account', function ($resource) {
        return $resource('app/rest/account', {}, {
        });
    });

cvappApp.factory('Password', function ($resource) {
        return $resource('app/rest/account/change_password', {}, {
        });
    });

cvappApp.factory('Sessions', function ($resource) {
        return $resource('app/rest/account/sessions/:series', {}, {
            'get': { method: 'GET', isArray: true}
        });
    });

cvappApp.factory('MetricsService',function ($http) {
    		return {
            get: function() {
...
cvappApp.factory('ThreadDumpService', function ($http) {
        return {
            dump: function() {
...
cvappApp.factory('HealthCheckService', function ($rootScope, $http) {
        return {
            check: function() {
...
cvappApp.factory('LogsService', function ($resource) {
...
cvappApp.factory('AuditsService', function ($http) {
        return {
            findAll: function() {
...
cvappApp.factory('Session', function () {
