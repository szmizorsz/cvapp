...
INSERT INTO T_COMPANY (id, name_en, name_hu, period_en, period_hu, description_en, description_hu) VALUES ('4', 'Sonrisa International Inc.','Sonrisa Informatikai Kft.', '2008.09 - Currently', '2009.09 - Jelenleg', 
'Sonrisa is a custom software development based IT company delivering custom solutions for the clients. My roles are mainly system and business analyst and occasionally project manager. I am involved in the whole life cycle of projects from planning and budgeting through delivery including development processes as well. I usually deliver UI and functional design and logical system design including logical and sometimes physical schema as well. I have always been involved in development phases from unit testing to screen implementations or any other architectural design. My goal is to keep my technical knowledge as up-to-date as possible.',
'Egyedi szoftver fejlesztésre alapuló informatikai cégnél rendszertervező, üzleti elemző, és esetenként projektvezető szerepkörök ellátása. A projektek teljes életútjának támogatása, illetve a megvalósításban való részvétel, egészen a fejlesztési folyamatokba való bekapcsolódásig. UI tervezés, séma tervezés, felület implementáció, unit tesztelés és egyéb architektúrális rétegek karbantartásán keresztül mindig igyekeztem frissen tartani a technikai tudásomat.');
...
INSERT INTO T_PROJECT (id, name_en, name_hu, client_en, client_hu, start, end, company_id, description_en, description_hu) VALUES ('14', 'KEKK-NLR','KEKK-NLR', 'KEKK-KH', 'KEKK-KH', '2008-08-01', '2009-03-01', '4',
...
INSERT INTO T_PROJECT_T_TECHNOLOGY (projects_id, technologys_id) VALUES ('14', '8');
INSERT INTO T_PROJECT_T_TECHNOLOGY (projects_id, technologys_id) VALUES ('14', '9');
INSERT INTO T_PROJECT_T_TECHNOLOGY (projects_id, technologys_id) VALUES ('14', '20');
INSERT INTO T_PROJECT_T_TECHNOLOGY (projects_id, technologys_id) VALUES ('14', '19');

INSERT INTO T_PROJECT (id, name_en, name_hu, client_en, client_hu, start, end, company_id, description_en, description_hu) VALUES ('13', 'KGR EGM','KGR EGM', 'Hungarian Treasury', 'Magyar Állam Kincstár', '2009-03-01', '2010-08-01', '4',
...
INSERT INTO T_PROJECT (id, name_en, name_hu, client_en, client_hu, start, end, company_id, description_en, description_hu) VALUES ('12', 'KGR K11','KGR K11', 'Hungarian Treasury', 'Magyar Állam Kincstár', '2010-06-01', '2011-03-01', '4',
...
INSERT INTO T_PROJECT (id, name_en, name_hu, client_en, client_hu, start, end, company_id, description_en, description_hu) VALUES ('11', 'MDM','MDM', 'Hungarian Treasury', 'Magyar Állam Kincstár', '2011-02-01', '2011-07-01', '4',
